...
export const FinalDetailsStepOne = () => {
      ...
      <div className="w-[50%]">
        <Formik initialValues={{}} onSubmit={() => {}}>
          <Form className="px-10 py-6 flex flex-col justify-between h-full">
            <div>
              <h1 className="font-black text-2xl">Who's listing this property for rent?</h1>
              <p className="font-light text-sm mb-3">
                Enter your information, unless you're creating the listing for someone else and
                they should be the main contact person.
              </p>
