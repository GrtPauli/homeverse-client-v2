...
export const FinalDetailsStepTwo = () => {
      ...
      <div className="w-[50%]">
        <Formik initialValues={{}} onSubmit={() => {}}>
          <Form className="px-10 py-6 flex flex-col justify-between h-full">
            <div>
              <h1 className="font-black text-2xl">Verify your phone number</h1>
              <p className="font-light text-sm mb-3">
                For your security, Zillow will send a one time verification code to this number to
                verify that this listing belongs to you.
              </p>
