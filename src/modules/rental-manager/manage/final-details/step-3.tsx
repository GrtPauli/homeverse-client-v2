...
export const FinalDetailsStepThree = () => {
      ...
      <div className="w-[50%]">
        <Formik initialValues={{}} onSubmit={() => {}}>
          <Form className="px-10 py-6 flex flex-col justify-between h-full">
            <div>
              <h1 className="font-black text-2xl">When are you available to show the property?</h1>
              <p className="font-light text-sm mb-3">Select your availability.</p>
