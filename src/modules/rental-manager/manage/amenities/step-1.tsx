      ...
      <div className="w-[50%]">
        <Formik initialValues={{}} onSubmit={() => {}}>
          <Form className="px-10 py-6 flex flex-col justify-between h-full">
            <div>
              <h1 className="font-black text-2xl">Which amenities does your property have?</h1>
              <p className="font-light text-sm mb-3">
                Share which amenities are available at your property.
              </p>
