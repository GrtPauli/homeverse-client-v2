      ...
      <div className="w-[50%]">
        <Formik initialValues={{}} onSubmit={() => {}}>
          <Form className="px-10 py-6 flex flex-col justify-between h-full">
            <div>
              <h1 className="font-black text-2xl">Where's the laundry located?</h1>
              <p className="font-light text-sm mb-3">
                Let renters know what kind of laundry facilities are available (if any).
              </p>
