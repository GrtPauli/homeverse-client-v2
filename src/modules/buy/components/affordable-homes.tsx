...
export const AffordableHomes = () => {
  return (
    <div className="pt-16 bg-light-cultured-3 px-14 pb-10">
      <h1 className="text-dark-prussian-blue font-extrabold text-2xl">Affordable Homes</h1>
      <Link
        href=""
